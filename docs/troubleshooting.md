...
| No gira | Activar L298 y medir motor | Puente H, motorreductor o atasco mecanico | Desacoplar motor y probar rotación manual. |
...
| Se traba la rotación | Rotar manualmente sin motor | Cremallera, polea, eje o bandeja desalineados | Reabrir CAD, alinear guias y liberar roces. |
...
1. Separar mecanica de electrica: probar rotación a mano antes de culpar al motor.

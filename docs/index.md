...
Documentación de fabricación del **nuevo diseño** de la incubadora.
...
- **Manual de montaje** — alcance, BOM consolidada, preparación de piezas, montaje mecánico,
  sistema de volteo, instalación eléctrica, mapa de señales, puesta en marcha y troubleshooting.
- **Inventario CAD** — inventario mecánico completo, con lista de corte/compra por pieza.
...
- **Volteo:** polea dentada + cremallera, rodamientos 624/626/HLM8UU, buje PTFE, acoples PA6.
